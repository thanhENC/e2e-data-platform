...
renamed as (
    select
        ...
        CAST( {{ adapter.quote("subtotal") }} as DECIMAL(20, 4) ) as sub_total,
        CAST( {{ adapter.quote("taxamt") }} as DECIMAL(20, 4) ) as tax_amount,
        CAST( {{ adapter.quote("freight") }} as DECIMAL(20, 4) ) as freight,
        CAST( {{ adapter.quote("totaldue") }} as DECIMAL(20, 4) ) as total_due,
